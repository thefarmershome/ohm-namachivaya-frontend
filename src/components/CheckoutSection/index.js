...
const CheckoutSection = ({ cartList }) => {
    ...
    console.log(location.state,"cartItemcartItem");
    // states
                                ...
                                <Grid className="chCardBody">
                                    <Collapse in={tabs.payment} timeout="auto">
                                        ...
                                        <Collapse in={forms.payment_method === 'card'} timeout="auto">
                                            <Grid>
                                                <CheckWrap amount={amount} cartItem={cartItem} customerInfo={forms}/>
                                            </Grid>
                                        </Collapse>
                                        ...
                                        <Table>
                                            <TableBody>
                                                ...
                                                <TableRow>
                                                    ...
                                                    <TableCell
                                                        align="right">{totalPrice(amount?.totalBillAmount)}</TableCell>
                                                </TableRow>
                                            </TableBody>
                                        </Table>
                                    </Grid>
